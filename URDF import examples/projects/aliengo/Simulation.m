function [cost]= Simulation(control, use_QR)
...
if use_QR
Handler_InverseDynamics = SRD_get_handler__InverseDynamicsConstrained_QR('Handler_ControlInput', Handler_Desired_State, ...
    'Handler_dynamics_generalized_coordinates_model', Handler_dynamics_generalized_coordinates_model, ...
