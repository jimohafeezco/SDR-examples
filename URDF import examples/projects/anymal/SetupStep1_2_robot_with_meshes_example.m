...
LinkArray = SRD_GetLinkArrayFromURDF('UrdfFilePath','../../robots_library/anymal/urdf/anymal_srd.urdf','ParseSTL',true);
Color_0 = [1, 0, 0];
...
% InitialPosition = [0,0, 0, pi/2, 0, 0, pi/2, 0, 0, pi/2, 0, 0, pi/2]';
